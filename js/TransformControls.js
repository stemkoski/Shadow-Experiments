...
class TransformControlsGizmo extends THREE.Object3D {
	...
	constructor() {
		...
		const gizmoRotate = {
			XYZE: [
				[ new THREE.Mesh( new THREE.CircleGeometry( 0.5, 1 ), matGray ), null, [ 0, Math.PI / 2, 0 ]]
			],
			X: [
				[ new THREE.Mesh( new THREE.CircleGeometry( 0.5, 0.5 ), matRed ) ]
			],
			Y: [
				[ new THREE.Mesh( new THREE.CircleGeometry( 0.5, 0.5 ), matGreen ), null, [ 0, 0, - Math.PI / 2 ]]
			],
			Z: [
				[ new THREE.Mesh( new THREE.CircleGeometry( 0.5, 0.5 ), matBlue ), null, [ 0, Math.PI / 2, 0 ]]
			],
			E: [
				[ new THREE.Mesh( new THREE.CircleGeometry( 0.75, 1 ), matYellowTransparent ), null, [ 0, Math.PI / 2, 0 ]]
			]
		};
